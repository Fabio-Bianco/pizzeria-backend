...
unset($__errorArgs, $__bag); ?>" 
                                                  placeholder="Descrivi la bevanda..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                                  placeholder="Temperature di servizio, abbinamenti..."><?php echo e(old('notes')); ?></textarea>
                                    ...
                                    <div class="col-12 mt-4">
                                        <div class="p-3 bg-light rounded">
                                            ...
                                            <ul class="small text-muted mb-0 ps-3">
                                                <li>Specifica la temperatura di servizio</li>
                                                <li>Indica eventuali allergeni</li>
                                                <li>Suggerisci abbinamenti</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app-modern', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Utente\Desktop\Backoffice-vetrrina-pizzeria-laravel\pizzeria-backend\resources\views/admin/beverages/create.blade.php ENDPATH**/ ?>