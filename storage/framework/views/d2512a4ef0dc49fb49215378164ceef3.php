    ...
    <div class="row justify-content-center">
      <div class="col-lg-6">
        <div class="text-center py-5">
          ...
          <a class="btn btn-outline-warning btn-sm" href="<?php echo e(route('admin.desserts.create')); ?>" aria-label="Crea il primo dessert">
            ...
            <div class="card-body py-3 px-3">
              <div class="d-flex align-items-center gap-3 flex-wrap flex-md-nowrap">
                ...
                <div class="pizza-actions d-flex flex-column flex-md-row gap-2 ms-md-3 mt-3 mt-md-0">
                  ...
                  <form method="POST" action="<?php echo e(route('admin.desserts.destroy', $d)); ?>">
...
<?php echo $__env->make('layouts.app-modern', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Utente\Desktop\my_project\Backoffice-vetrrina-pizzeria-laravel\pizzeria-backend\resources\views/admin/desserts/index.blade.php ENDPATH**/ ?>