...
<?php $__env->startSection('title', 'Modifica Dessert'); ?>
...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <form action="<?php echo e(route('admin.desserts.update', $dessert)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                name="description" 
                                rows="3"
                            ><?php echo e(old('description', $dessert->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <?php if($dessert->image_path): ?>
                                <div class="mb-2">
                                    <img src="<?php echo e(asset('storage/' . $dessert->image_path)); ?>" alt="<?php echo e($dessert->name); ?>" class="img-thumbnail" style="max-width: 200px;">
                                </div>
                            <?php endif; ?>
                            <input 
                                type="file" 
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check form-switch">
                                    <input 
                                        ...
                                        name="is_vegan" 
                                        value="1"
                                        <?php echo e(old('is_vegan', $dessert->is_vegan) ? 'checked' : ''); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check form-switch">
                                    <input 
                                        ...
                                        name="is_gluten_free" 
                                        value="1"
                                        <?php echo e(old('is_gluten_free', $dessert->is_gluten_free) ? 'checked' : ''); ?>
                            ...
                            >
                                <?php $__currentLoopData = $ingredients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ingredient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option 
                                        ...
                                        <?php echo e(in_array($ingredient->id, old('ingredients', $dessert->ingredients ? $dessert->ingredients->pluck('id')->toArray() : [])) ? 'selected' : ''); ?>
                            ...
                            <?php $__currentLoopData = $allergens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allergen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check">
                                    <input 
                                        ...
                                        <?php echo e(in_array($allergen->id, old('allergens', $dessert->allergens ? $dessert->allergens->pluck('id')->toArray() : [])) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.app-modern', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Utente\Desktop\Backoffice-vetrrina-pizzeria-laravel\pizzeria-backend\resources\views/admin/desserts/edit.blade.php ENDPATH**/ ?>